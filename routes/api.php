...
Route::middleware('web')->prefix('v1')->group(function (): void {
    ...
    Route::middleware('auth')->group(function (): void {
        ...
        Route::middleware('tenant')->group(function (): void {
            ...
            Route::get('/imports/definitions', [ImportController::class, 'definitions']);
            Route::get('/import-templates/{type}', [ImportController::class, 'template']);
            Route::get('/imports', [ImportController::class, 'index']);
            Route::post('/imports', [ImportController::class, 'store']);
            Route::get('/imports/{importBatch}', [ImportController::class, 'show']);
            Route::post('/imports/{importBatch}/dry-run', [ImportController::class, 'dryRun']);
            Route::post('/imports/{importBatch}/confirm', [ImportController::class, 'confirm']);
            Route::post('/imports/{importBatch}/rollback', [ImportController::class, 'rollback']);
